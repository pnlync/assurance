...
- [x] **CSO Irish Life Tables No. 17** — only Table 1 (male) and Table 2 (female); keep the CSO file names
...
- [x] **EIOPA risk-free rates** — the four monthly zip files, saved as downloaded (no need to unzip):
